    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar main-sidebar-custom sidebar-dark-info elevation-4">
            <a href="{{ url('') }}" class="brand-link">
                <img src="{{ asset('') }}dist/img/logo-silobur.png" alt="Logo Silobur"
                    class="brand-image elevation-3" style="opacity: .8">
                <span
                    class="brand-text font-weight-light "><strong>{{ env('APP_NAME', 'Silobur') }}</strong></span>
            </a>
            <div class="sidebar">
                <nav class="mt-2">
        ...
        <footer class="main-footer">
            ...
            <strong>&copy; {{ date('Y') }} Sistem Inovasi Lomba Burung (SiLoBur)</strong>
        </footer>
    </div>
