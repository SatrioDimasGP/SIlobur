        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="{{ route('data-pendaftaran.index') }}" class="btn btn-tool"><i
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mt-3">
                    <form action="{{ route('data-pendaftaran.destroy', $pemesanan) }}" method="POST"
                    ...
                    <a href="{{ route('data-pendaftaran.index') }}" class="btn btn-secondary">Kembali</a>
                </div>
