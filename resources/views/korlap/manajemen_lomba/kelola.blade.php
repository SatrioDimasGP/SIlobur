...
@section('content')
    <div class="container">
        ...
        <h1 class="mb-4 d-flex justify-content-between align-items-center">
            <span>Kelola Lomba: {{ $lomba->nama }}</span>
            <a href="{{ route('manajemen-lomba.index') }}" class="btn btn-tool">
                <i class="fas fa-arrow-alt-circle-left"></i>
            </a>
        </h1>
        <div class="mb-3 d-flex gap-2">
            <a href="{{ route('manajemen-lomba.kelola.burung.create', ['lomba_id' => $lomba->id]) }}"
                class="btn btn-success">
                + Tambah Gabungan Jenis Burung dan Kelas
            </a>
            <a href="{{ route('manajemen-lomba.kelola.gantangan.index', ['lomba_id' => $lomba->id]) }}"
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('manajemen-lomba.kelola.jenis-burung.store', ['lomba_id' => $lomba->id]) }}"
                            method="POST">
                            @csrf
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-striped w-100" id="tabel-jenis-burung">
                            ...
                            <tbody>
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('manajemen-lomba.kelola.burung.jenis-burung.edit', ['lomba_id' => $lomba->id, 'id' => $jenisBurung->id]) }}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form
                                                            action="{{ route('manajemen-lomba.kelola.jenis-burung.destroy', ['lomba_id' => $lomba->id, 'id' => $jenisBurung->id]) }}"
                                                            method="POST"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="3" class="text-center">Belum ada jenis burung.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
            ...
            <div class="col-md-6">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('manajemen-lomba.kelola.kelas.store', ['lomba_id' => $lomba->id]) }}"
                            method="POST">
                            @csrf
                            <input type="hidden" name="lomba_id" value="{{ $lomba->id }}">
                            <div class="form-group mb-2">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <a class="dropdown-item"
                                                            href="{{ route('manajemen-lomba.kelola.kelas.edit', ['lomba_id' => $lomba->id, 'id' => $item->id]) }}">Edit</a>
                                                    </li>
                                                    <li>
                                                        <form
                                                            action="{{ route('manajemen-lomba.kelola.kelas.destroy', ['lomba_id' => $lomba->id, 'id' => $item->id]) }}"
                                                            method="POST"
                                                            onsubmit="return confirm('Yakin ingin menghapus?')">
                                                            @csrf @method('DELETE')
                                                            <button type="submit" class="dropdown-item">Hapus</button>
