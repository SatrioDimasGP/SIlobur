                ...
                <div class="col-md-6">
                    ...
                    <div class="stats-container mt-4">
                        <div class="stats-card">
                            <div class="stat-item">
                                <div class="stat-label">Jumlah Lomba: </div>
                                <div class="stat-value" style="font-family: 'Red Hat Text', sans-serif;">10+</div>
                            </div>
                            <div class="stats-divider"></div>
                            <div class="stat-item">
                                <div class="stat-label">Juri Terdaftar: </div>
                                <div class="stat-value" style="font-family: 'Red Hat Text', sans-serif;">30+</div>
                            </div>
                            <div class="stats-divider"></div>
                            <div class="stat-item">
                                <div class="stat-label">Peserta Lomba: </div>
                                <div class="stat-value" style="font-family: 'Red Hat Text', sans-serif;">500+</div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="py-5 mb-5 bg-white font-redhat" id="Fitur">
        <div class="container">
            ...
            <div class="col-md-5 text-center mt-5 mx-auto">
                ...
                <div class="service-image mb-4">
                    <img src="{{ asset('assets/images/laporan.png') }}" alt="Rekap & Laporan" class="img-fluid" style="max-height: 200px;">
                </div>
                <p class="text-center px-3">
