        ...
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <strong>Jenis Burung:</strong> {{ $burung?->jenisBurung?->nama ?? '-' }} <br>
                    <strong>Kelas:</strong> {{ $burung?->kelas?->nama ?? '-' }}
                </div>
                        ...
                        <tbody>
                            @forelse ($penilaians as $penilaian)
                                <tr>
                                    ...
                                    <td>{{ $penilaian->created_at ? $penilaian->created_at->format('d M Y H:i') : '-' }}
                                    </td>
                                </tr>
                            @empty
                                <tr>
