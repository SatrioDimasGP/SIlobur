...
<div class="container">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="nama_input" id="nama_input" class="form-control" value="{{ old('nama', Auth::user()->name) }}" required>
    </div>
    <div class="mb-3">
        ...
        fetch(`/ajax/gantangan?jenis_burung_id=${jenisId}&kelas_id=${kelasId}&lomba_id={{ $lomba->id }}`)
            ...
            .then(data => {
                ...
                if (data.gantangans.length === 0) {
                    daftarGantangan.innerHTML = '<p class="text-muted">Tidak ada nomor gantangan tersedia.</p>';
                    return;
                }
                            ...
                            btn.addEventListener('click', () => {
                                ...
                                if (index === -1) {
                                    ...
                                    cart.push({
                                        ...
                                        nomor: item.nomor,
                                        jenis_id: jenisId,
                                        jenis_nama: jenisSelect.options[jenisSelect.selectedIndex].text,
                                        kelas_id: kelasId,
